...
var vm = new Vue({
    ...
    methods: {
        getSaleCategory: function(){
            //加载类别树
            $.get(baseURL + "sale/saleCategory/select", function(r){
        ...
        update: function () {
            ...
            $.get(baseURL + "sale/saleCategory/info/"+categoryId, function(r){
                vm.showList = false;
                vm.title = "修改";
        ...
        del: function () {
            ...
            confirm('确定要删除选中的记录？', function(){
                $.ajax({
                    type: "POST",
                    url: baseURL + "sale/saleCategory/delete",
        ...
        saveOrUpdate: function (event) {
            var url = vm.saleCategory.id == null ? "sale/saleCategory/save" : "sale/saleCategory/update";
            $.ajax({
                type: "POST",
                url: baseURL + url,
...
$(function () {
    $.get(baseURL + "sale/saleCategory/info", function(r){
        var colunms = SaleCategory.initColumn();
        var table = new TreeTable(SaleCategory.id, baseURL + "sale/saleCategory/list", colunms);
