...
import io.fhao.modules.sys.entity.SysColumn;
import io.fhao.modules.sys.entity.SysTable;
...
public class GeneratorUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		for(String template : templates){
			...
			try {
				...
				throw new FhaoException("渲染模板失败，表名：" + sysTable.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new FhaoException("获取配置文件失败，", e);
		}
	}
