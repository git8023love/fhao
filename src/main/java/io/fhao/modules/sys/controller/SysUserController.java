...
import io.fhao.common.validator.ValidatorUtils;
import io.fhao.common.validator.group.AddGroup;
import io.fhao.common.validator.group.UpdateGroup;
...
public class SysUserController extends AbstractController {
	...
	public Result updatePassword(String password, String newPassword){
		if(StringUtils.isBlank(newPassword)){
			throw new FhaoException("新密码不为能空");
		}
